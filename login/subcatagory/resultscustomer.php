...
<body>
<div class="tfield">
<form method="get" action="resultscustomer.php" enctype="multipart/form-data">
...
<a href="../catagory/catagorycustomer.php"><div id="btn1">&nbsp;&nbsp;Categories</div></a>
	...
	if($run_pro)
	{
		while($row_pro = mysqli_fetch_array($run_pro))
		{
			...
			echo "<td><div class='block'><center><div class='name'>$pro_title</div><div class='image'><img src='../../admin/product_images/$pro_image'/>
				</div><div class='price'>Price: $ $pro_price</div><div class='add'><button>ADD TO CART</button>
				</div></center></div></td>";
