...
<table width="88%" height="561" border="0" align="center">
  <tr>
	...
	while($row_subcats = mysqli_fetch_array($run_subcats))
	{
		...
		if(strcmp($cat,$str)==0)
		{
			echo "<li><a href='../subcatagory/home.php?sub=$sub_id'>$sub_title</a></li>";
		}
	}
	?>
	</center>
...
<span style="position:absolute;right:250px;bottom:90px; ">
<a href="https://www.facebook.com/GroceryFocus"><img src="fb.png" width="50" height="50" /></a>
</span>
<span style="position:absolute;right:190px;bottom:90px; ">
